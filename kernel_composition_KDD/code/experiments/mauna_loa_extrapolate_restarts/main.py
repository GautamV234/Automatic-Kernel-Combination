...
# Importing libraries
##############################
from kernel_composition_KDD.code.model.model_restarts import Best_model_params, Inference, KernelCombinations
import numpy as np
import torch
...
# class covar_kernels():
#     def __init__(self, kernel_list:list[str],num_features=1,device='cpu'):
...
#     # Defining paths
#     #####################################
#     root_path = '/home/gautam.pv/nlim/kernel_composition_KDD/code/experiments/mauna_loa_extrapolate_restarts'
#     data_path = '/home/gautam.pv/nlim/kernel_composition_KDD/data/mauna2011.mat'
#     yaml_file = '/home/gautam.pv/nlim/kernel_composition_KDD/yaml/mauna_loa_extrapolate_restarts.yaml'
#     ######################################
#     # Data Loading
#     ######################################
...
#                                             ckpt_path=ckpt_path, device=device, reinitialize=ckpt, num_initializations=10,num_epochs=num_epochs, lr=lr,stopping=stopping)
