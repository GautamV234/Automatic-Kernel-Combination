...
if __name__ == '__main__':
    ...
    # Defining paths
    #####################################
    root_path = '/home/gautam.pv/nlim/kernel_composition_KDD/code/experiments/mauna_loa_scaled_extrapolate_linear'
    data_path = '/home/gautam.pv/nlim/kernel_composition_KDD/data/mauna2011.mat'
    yaml_file = '/home/gautam.pv/nlim/kernel_composition_KDD/yaml/mauna_loa_scaled_extrapolate_linear.yaml'
    ######################################
    # Data Loading
    ######################################
    X, y = data_loader(data_path)
    # get the train and test data by keeping the last 30% of the data as test data
