...
if __name__ == '__main__':
    ...
    # Defining paths
    #####################################
    root_path = '/home/gautam.pv/nlim/kernel_composition_KDD/code/experiments/multi_dimensional_exps'
    data_path = '/home/gautam.pv/nlim/kernel_composition_KDD/data/mauna2011.mat'
    yaml_file = '/home/gautam.pv/nlim/kernel_composition_KDD/yaml/mauna_loa_linear.yaml'
    ######################################
    # Data Loading
    ######################################
    ...
    'Linear': gpytorch.kernels.LinearKernel().to(device),
    'Matern32': gpytorch.kernels.MaternKernel(nu=1.5).to(device)}
