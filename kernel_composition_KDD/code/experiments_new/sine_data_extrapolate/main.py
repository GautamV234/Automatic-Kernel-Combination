...
if __name__ == '__main__':
    ...
    #####################################
    print(os.getcwd())
    root_path = os.path.join(os.getcwd(), "kernel_composition_KDD","code","experiments_new", "sine_data_extrapolate")
    ...
    yaml_file = os.path.join(os.getcwd(), "kernel_composition_KDD","yaml", "new_sine.yaml")
    # yaml_file = '/home/gautam.pv/nlim/kernel_composition_KDD/yaml/mauna_loa_extrapolate_lbfgs.yaml'
    ######################################
    # Data Loading
    ######################################
    ...
    Y_train = np.sin(X_train) + np.random.randn(100, 1) * 0.05
    X_test = np.random.uniform(20, 30, (20, 1))
    Y_test = np.sin(X_test) + np.random.randn(20, 1) * 0.05
    ##########################
