...
if __name__ == '__main__':
    ...
    #####################################
    print(os.getcwd())
    root_path = os.path.join(os.getcwd(), "kernel_composition_KDD","code","experiments_new", "synt_data_interp2")
    ...
    fixed_kernel_combination = GPy.kern.Matern32(1,0.2,0.2)*GPy.kern.Linear(1,0.3)*GPy.kern.RatQuad(1,1.9,1)
